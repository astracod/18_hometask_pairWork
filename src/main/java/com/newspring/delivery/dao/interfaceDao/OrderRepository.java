...
public interface OrderRepository extends JpaRepository<Orders, Long> {
    ...
    @Modifying
    @Query(
            value = "select o from Orders o where" +
    ...
    List<Orders> advancedOrderSearch(@Param("name") String name,
    ...
    @Modifying
    @Query(value =
            "update Orders o set  o.name = :name, o.description = :description, o.address = :address" +
